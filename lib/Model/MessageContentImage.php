 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MessageContentImage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MessageContent_image';
     ...
     * Sets sizes
     *
     * @param object $sizes объект ключ-значение, где ключи - строки в формате \"ШxВ\" (ширина, высота), а значения - ссылки на изображения
     *
     * @return $this
     */
